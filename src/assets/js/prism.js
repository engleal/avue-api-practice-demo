						...
						for (var l in n) {
							if (n.hasOwnProperty(l)) {
								...
								var o = n[l],
									s = M.util.type(o)
								s !== 'Object' || a[i(o)]
									? s !== 'Array' || a[i(o)] || ((a[i(o)] = !0), e(o, r, l, a))
...
!(function() {
	...
	function l(u, e, d) {
		var t = (e = typeof e === 'string' ? e : u.getAttribute('data-line'))
				.replace(/\s+/g, '')
				.split(',')
				.filter(Boolean),
...
;(typeof self !== 'undefined' && !self.Prism) ||
	...
	Prism.hooks.add('wrap', function(e) {
		e.type === 'keyword' && e.classes.push('keyword-' + e.content)
	})
