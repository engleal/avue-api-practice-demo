...
export default {
	...
	data() {
		return {
			title: ComponentSource.dataBox.title,
			subTitle: ComponentSource.dataBox.subTitle,
			effectDesc: ComponentSource.dataBox.effectDesc,
			scene: ComponentSource.dataBox.scene,
			anchorSource: ComponentSource.dataBox.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.dataBox.attributes,
			eventSource: ComponentSource.dataBox.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
