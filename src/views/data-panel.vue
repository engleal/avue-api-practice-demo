...
export default {
	...
	data() {
		return {
			title: ComponentSource.dataPanel.title,
			subTitle: ComponentSource.dataPanel.subTitle,
			effectDesc: ComponentSource.dataPanel.effectDesc,
			scene: ComponentSource.dataPanel.scene,
			anchorSource: ComponentSource.dataPanel.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.dataPanel.attributes,
			eventSource: ComponentSource.dataPanel.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
