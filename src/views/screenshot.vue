...
export default {
	...
	data() {
		return {
			title: ComponentSource.screenshot.title,
			subTitle: ComponentSource.screenshot.subTitle,
			effectDesc: ComponentSource.screenshot.effectDesc,
			scene: ComponentSource.screenshot.scene,
			anchorSource: ComponentSource.screenshot.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.screenshot.attributes,
			eventSource: ComponentSource.screenshot.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
