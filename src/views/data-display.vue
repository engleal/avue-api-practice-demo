...
export default {
	...
	data() {
		return {
			title: ComponentSource.dataDisplay.title,
			subTitle: ComponentSource.dataDisplay.subTitle,
			effectDesc: ComponentSource.dataDisplay.effectDesc,
			scene: ComponentSource.dataDisplay.scene,
			anchorSource: ComponentSource.dataDisplay.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.dataDisplay.attributes,
			eventSource: ComponentSource.dataDisplay.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
