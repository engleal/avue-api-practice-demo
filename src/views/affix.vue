      ...
      <template slot="content">
        ...
        <rc-code-card id="JCYF" title="基本用法" desc="基本使用。">
          <template slot="effect">
            <avue-affix :offset-bottom="100" @on-change="affixEvent">
...
export default {
	...
	data() {
		return {
			title: ComponentSource.affix.title,
			subTitle: ComponentSource.affix.subTitle,
			effectDesc: ComponentSource.affix.effectDesc,
			scene: ComponentSource.affix.scene,
			anchorSource: ComponentSource.affix.anchor,
			attributesSource: ComponentSource.affix.attributes,
			eventSource: ComponentSource.affix.events,
			codeSnippet: ''
		}
	},
	// 计算属性 一个数据受多个数据影响
