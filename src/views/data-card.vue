...
export default {
  ...
  data() {
    return {
        title: ComponentSource.dataCard.title,
        subTitle: ComponentSource.dataCard.subTitle,
        effectDesc: ComponentSource.dataCard.effectDesc,
        scene: ComponentSource.dataCard.scene,
        anchorSource: ComponentSource.dataCard.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.dataCard.attributes,
        eventSource: ComponentSource.dataCard.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
