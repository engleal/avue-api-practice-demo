...
export default {
  ...
  data() {
    return {
        title: ComponentSource.dataPrice.title,
        subTitle: ComponentSource.dataPrice.subTitle,
        effectDesc: ComponentSource.dataPrice.effectDesc,
        scene: ComponentSource.dataPrice.scene,
        anchorSource: ComponentSource.dataPrice.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.dataPrice.attributes,
        eventSource: ComponentSource.dataPrice.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
