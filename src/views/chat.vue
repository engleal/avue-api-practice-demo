...
export default {
	...
	data() {
		return {
			title: ComponentSource.chat.title,
			subTitle: ComponentSource.chat.subTitle,
			effectDesc: ComponentSource.chat.effectDesc,
			scene: ComponentSource.chat.scene,
			anchorSource: ComponentSource.chat.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.chat.attributes,
			eventSource: ComponentSource.chat.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
