...
export default {
	...
	data() {
		return {
			title: ComponentSource.dataIcons.title,
			subTitle: ComponentSource.dataIcons.subTitle,
			effectDesc: ComponentSource.dataIcons.effectDesc,
			scene: ComponentSource.dataIcons.scene,
			anchorSource: ComponentSource.dataIcons.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.dataIcons.attributes,
			eventSource: ComponentSource.dataIcons.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
