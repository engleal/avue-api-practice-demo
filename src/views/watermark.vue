...
export default {
	...
	data() {
		return {
			title: ComponentSource.watermark.title,
			subTitle: ComponentSource.watermark.subTitle,
			effectDesc: ComponentSource.watermark.effectDesc,
			scene: ComponentSource.watermark.scene,
			anchorSource: ComponentSource.watermark.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.watermark.attributes,
			eventSource: ComponentSource.watermark.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
