...
export default {
  ...
  data() {
    return {
        title: ComponentSource.dataPay.title,
        subTitle: ComponentSource.dataPay.subTitle,
        effectDesc: ComponentSource.dataPay.effectDesc,
        scene: ComponentSource.dataPay.scene,
        anchorSource: ComponentSource.dataPay.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.dataPay.attributes,
        eventSource: ComponentSource.dataPay.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
