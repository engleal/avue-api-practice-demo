...
export default {
	...
	data() {
		return {
			title: ComponentSource.exportXlsx.title,
			subTitle: ComponentSource.exportXlsx.subTitle,
			effectDesc: ComponentSource.exportXlsx.effectDesc,
			scene: ComponentSource.exportXlsx.scene,
			anchorSource: ComponentSource.exportXlsx.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.exportXlsx.attributes,
			eventSource: ComponentSource.exportXlsx.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
