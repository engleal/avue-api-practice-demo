...
export default {
  ...
  data() {
    return {
        title: ComponentSource.dataTabs.title,
        subTitle: ComponentSource.dataTabs.subTitle,
        effectDesc: ComponentSource.dataTabs.effectDesc,
        scene: ComponentSource.dataTabs.scene,
        anchorSource: ComponentSource.dataTabs.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.dataTabs.attributes,
        eventSource: ComponentSource.dataTabs.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
