...
export default {
  ...
  data() {
    return {
        title: ComponentSource.video.title,
        subTitle: ComponentSource.video.subTitle,
        effectDesc: ComponentSource.video.effectDesc,
        scene: ComponentSource.video.scene,
        anchorSource: ComponentSource.video.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.video.attributes,
        eventSource: ComponentSource.video.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
