...
export default {
	...
	data() {
		return {
			title: ComponentSource.dataOperaText.title,
			subTitle: ComponentSource.dataOperaText.subTitle,
			effectDesc: ComponentSource.dataOperaText.effectDesc,
			scene: ComponentSource.dataOperaText.scene,
			anchorSource: ComponentSource.dataOperaText.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.dataOperaText.attributes,
			eventSource: ComponentSource.dataOperaText.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
