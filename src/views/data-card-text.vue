...
export default {
  ...
  data() {
    return {
        title: ComponentSource.dataCardText.title,
        subTitle: ComponentSource.dataCardText.subTitle,
        effectDesc: ComponentSource.dataCardText.effectDesc,
        scene: ComponentSource.dataCardText.scene,
        anchorSource: ComponentSource.dataCardText.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.dataCardText.attributes,
        eventSource: ComponentSource.dataCardText.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
