...
export default {
  ...
  data() {
    return {
        title: ComponentSource.nProgress.title,
        subTitle: ComponentSource.nProgress.subTitle,
        effectDesc: ComponentSource.nProgress.effectDesc,
        scene: ComponentSource.nProgress.scene,
        anchorSource: ComponentSource.nProgress.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.nProgress.attributes,
        eventSource: ComponentSource.nProgress.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
