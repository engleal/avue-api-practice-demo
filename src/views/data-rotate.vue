...
export default {
	...
	data() {
		return {
			title: ComponentSource.dataRotate.title,
			subTitle: ComponentSource.dataRotate.subTitle,
			effectDesc: ComponentSource.dataRotate.effectDesc,
			scene: ComponentSource.dataRotate.scene,
			anchorSource: ComponentSource.dataRotate.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.dataRotate.attributes,
			eventSource: ComponentSource.dataRotate.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
