...
export default {
  ...
  data() {
    return {
        title: ComponentSource.inputMap.title,
        subTitle: ComponentSource.inputMap.subTitle,
        effectDesc: ComponentSource.inputMap.effectDesc,
        scene: ComponentSource.inputMap.scene,
        anchorSource: ComponentSource.inputMap.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.inputMap.attributes,
        eventSource: ComponentSource.inputMap.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
