...
export default {
  ...
  data() {
    return {
        title: ComponentSource.exportExcel.title,
        subTitle: ComponentSource.exportExcel.subTitle,
        effectDesc: ComponentSource.exportExcel.effectDesc,
        scene: ComponentSource.exportExcel.scene,
        anchorSource: ComponentSource.exportExcel.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.exportExcel.attributes,
        eventSource: ComponentSource.exportExcel.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
