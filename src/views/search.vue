...
export default {
	...
	data() {
		return {
			title: ComponentSource.search.title,
			subTitle: ComponentSource.search.subTitle,
			effectDesc: ComponentSource.search.effectDesc,
			scene: ComponentSource.search.scene,
			anchorSource: ComponentSource.search.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.search.attributes,
			eventSource: ComponentSource.search.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
