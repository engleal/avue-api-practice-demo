...
export default {
  ...
  data() {
    return {
        title: ComponentSource.license.title,
        subTitle: ComponentSource.license.subTitle,
        effectDesc: ComponentSource.license.effectDesc,
        scene: ComponentSource.license.scene,
        anchorSource: ComponentSource.license.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.license.attributes,
        eventSource: ComponentSource.license.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
