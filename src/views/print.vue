...
export default {
	...
	data() {
		return {
			title: ComponentSource.print.title,
			subTitle: ComponentSource.print.subTitle,
			effectDesc: ComponentSource.print.effectDesc,
			scene: ComponentSource.print.scene,
			anchorSource: ComponentSource.print.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.print.attributes,
			eventSource: ComponentSource.print.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
