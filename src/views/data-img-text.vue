...
export default {
  ...
  data() {
    return {
        title: ComponentSource.dataImgText.title,
        subTitle: ComponentSource.dataImgText.subTitle,
        effectDesc: ComponentSource.dataImgText.effectDesc,
        scene: ComponentSource.dataImgText.scene,
        anchorSource: ComponentSource.dataImgText.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.dataImgText.attributes,
        eventSource: ComponentSource.dataImgText.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
