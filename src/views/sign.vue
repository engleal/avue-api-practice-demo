...
export default {
	...
	data() {
		return {
			title: ComponentSource.sign.title,
			subTitle: ComponentSource.sign.subTitle,
			effectDesc: ComponentSource.sign.effectDesc,
			scene: ComponentSource.sign.scene,
			anchorSource: ComponentSource.sign.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.sign.attributes,
			eventSource: ComponentSource.sign.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
