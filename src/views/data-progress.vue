...
export default {
  ...
  data() {
    return {
        title: ComponentSource.dataProgress.title,
        subTitle: ComponentSource.dataProgress.subTitle,
        effectDesc: ComponentSource.dataProgress.effectDesc,
        scene: ComponentSource.dataProgress.scene,
        anchorSource: ComponentSource.dataProgress.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.dataProgress.attributes,
        eventSource: ComponentSource.dataProgress.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
