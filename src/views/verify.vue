...
export default {
  ...
  data() {
    return {
        title: ComponentSource.verify.title,
        subTitle: ComponentSource.verify.subTitle,
        effectDesc: ComponentSource.verify.effectDesc,
        scene: ComponentSource.verify.scene,
        anchorSource: ComponentSource.verify.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.verify.attributes,
        eventSource: ComponentSource.verify.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
