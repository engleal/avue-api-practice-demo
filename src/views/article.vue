...
export default {
  ...
  data() {
    return {
        title: ComponentSource.article.title,
        subTitle: ComponentSource.article.subTitle,
        effectDesc: ComponentSource.article.effectDesc,
        scene: ComponentSource.article.scene,
        anchorSource: ComponentSource.article.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.article.attributes,
        eventSource: ComponentSource.article.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
