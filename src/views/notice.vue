...
export default {
  ...
  data() {
    return {
        title: ComponentSource.notice.title,
        subTitle: ComponentSource.notice.subTitle,
        effectDesc: ComponentSource.notice.effectDesc,
        scene: ComponentSource.notice.scene,
        anchorSource: ComponentSource.notice.anchor,
        codeSnippet: "",
        aVueValue: "我是内容",
        attributesSource: ComponentSource.notice.attributes,
        eventSource: ComponentSource.notice.events
    };
  },
  // 实例创建前 无el 无data
  beforeCreate() {},
