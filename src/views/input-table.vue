...
export default {
	...
	data() {
		return {
			title: ComponentSource.inputTable.title,
			subTitle: ComponentSource.inputTable.subTitle,
			effectDesc: ComponentSource.inputTable.effectDesc,
			scene: ComponentSource.inputTable.scene,
			anchorSource: ComponentSource.inputTable.anchor,
			codeSnippet: '',
			aVueValue: '我是内容',
			attributesSource: ComponentSource.inputTable.attributes,
			eventSource: ComponentSource.inputTable.events
		}
	},
	// 计算属性 一个数据受多个数据影响
	computed: {},
