let titleSource = "avue-input-tree";

let subTitleSource = "选择输入框";

let effectDescSource = "点击选择一个tree型数据，支持单选和多选";

let sceneSource = {
    title: "何时使用",
    desc: "",
    features: [
        "当数据像树一样的结构时，想要获取最深层的子数据时使用"
    ]
};
...
let attributesList = [
    ...
    {
        attribute: "leafOnly",
        desc: "是否只是叶子节点,影响tree组件选中节点之后的返回值是否只是叶子节点的值",
        dataType: "boolean",
        params: "-",
        value:"true/false",
        defaultValue: "false"
    ...
    },
    {
        ...
        desc: "在multiple为true的情况下，是否严格的遵循父子不互相关联的做法，默认为 false",
        dataType: "boolean",
        params: "-",
        value:"true/false",
        defaultValue: "false"
    ...
    {
        attribute: "parent",
        desc: "是否不禁用父类选中，此情况只在dic属性中children的属性值为有值时才生效，将会影响dic属性的每个对象，默认添加$parent属性",
        dataType: "boolean",
        params: "-",
        value:"true/false",
        defaultValue: "true"
    ...
    },
    {
        ...
        desc: "影响select控件的value属性，是一个函数用来处理选中数据显示的值。比如你选中了某一项，你可以应用这个函数对这个值进行自定义显示，比如结果 + -- 之类的",
        dataType: "Function",
    ...
    {
        attribute: "treeLoad",
        desc: "只有当lazy为true时才生效。tree节点加载数据钩子函数，注意要调用callBack函数,callBack做了数据返回的操作",
        dataType: "Function",
    ...
    },
    {
        ...
        dataType: "Function",
        params: "1、checkedNodes:选中的节点 2、checkedKeys:选中的key 3、halfCheckedNodes 4、halfCheckedKeys ",
        value:"-",
        defaultValue: "-"
    },
