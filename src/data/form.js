const titleSource = 'avue-form'

const subTitleSource = '表单验证'

const effectDescSource = '表单验证组件'
...
const attributesList = [
	...
	},
	{
		...
		desc: '表单域标签的后缀,会在avue-from的子表单控件上的label后面加上这个字段',
		dataType: 'number',
		params: '-',
		value: '',
		defaultValue: '-'
